...
public class AccountConfirmationPage {
    ...
    private final By popUpWindowCloseButton = By.xpath("//*[@id=\"dismiss-button\"]");
    ...
    public void clickOnPopUpWindowClosingButton() {
        element = driver.findElement(popUpWindowCloseButton);
        element.click();
    }
}
